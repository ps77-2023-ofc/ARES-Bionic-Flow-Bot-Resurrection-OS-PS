...
$welcomeMessage = {
    ...
    Write-Host "¡Hola! Te doy la bienvenida. Soy ARES Bionic-Flow, el script tipo bot automatizado oficial de Resurrection OS, y estoy aquí para ayudarte a dar tus primeros pasos con Resurrection OS, o ayudarte mientras lo usas."
...
if ($isAdmin) {
    ...
    Write-Host "Esto pasó: No me has ejecutado con privilegios de Administrador. ¡No puedo funcionar correctamente si no me ejecutas con privilegios de Administrador! Ya que muchas de las cosas que hago requieren realizar cambios en el sistema, que requieren de aprobación."
