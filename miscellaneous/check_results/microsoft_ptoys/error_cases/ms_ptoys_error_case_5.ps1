function Assert-Requirements-Error-Case-5 {
...
Assert-Requirements-Error-Case-5
$compatCheckFailedCase5 = "case-5-requirements-not-met"
$env:MSPTCompatFallidaCaso5 = $compatCheckFailedCase5