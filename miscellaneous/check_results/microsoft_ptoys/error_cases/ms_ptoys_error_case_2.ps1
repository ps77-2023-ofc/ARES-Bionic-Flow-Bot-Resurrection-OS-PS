function Assert-Requirements-Error-Case-2 {
...
Assert-Requirements-Error-Case-2
$compatCheckFailedCase2 = "case-2-requirements-not-met"
$env:MSPTCompatFallidaCaso2 = $compatCheckFailedCase2