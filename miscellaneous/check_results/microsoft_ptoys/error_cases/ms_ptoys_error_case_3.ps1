function Assert-Requirements-Error-Case-3 {
...
Assert-Requirements-Error-Case-3
$compatCheckFailedCase3 = "case-3-requirements-not-met"
$env:MSPTCompatFallidaCaso3 = $compatCheckFailedCase3