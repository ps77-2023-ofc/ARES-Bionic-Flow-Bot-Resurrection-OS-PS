function Assert-Requirements-Error-Case-1 {
...
Assert-Requirements-Error-Case-1
$compatCheckFailedCase1 = "case-1-requirements-not-met"
$env:MSPTCompatFallidaCaso1 = $compatCheckFailedCase1 